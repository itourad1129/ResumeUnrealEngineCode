...
void APlayerControlCharacter::Init(int32 InPlayerID)
{
}

void APlayerControlCharacter::Init(UPlayerData InPlayerData)
{
}

// Called every frame
void APlayerControlCharacter::Tick(const float DeltaTime)
{
